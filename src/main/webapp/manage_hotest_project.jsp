...
<%
	String jsonArray = (String) application.getAttribute("hotHouseInfoList");
%>
       		...
       		<div class="wrap">
                ...
                <form method="post" id="uploadForm" action="addHouseInfo.action" enctype="multipart/form-data">
               		<table>
                        ...
                        <tr><td>装修类型</td><td><input type="text" id="decoration" name="decoration" class="tableCss" value="" /><input type="hidden" name="mark" value="hot" /></td></tr>
